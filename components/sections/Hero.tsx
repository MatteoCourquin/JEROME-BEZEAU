...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="fixed inset-0 -z-10 flex h-screen w-screen flex-col justify-center overflow-hidden px-x-default py-y-default text-left sm:items-center sm:text-center"
    >
